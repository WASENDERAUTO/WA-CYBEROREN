...
<div id="accordionPayment" class="accordion">
    <div class="card">
        <div class="card-body">
            ...
            <span class="text-info">Endpoint :</span> <?php echo config('app.base_node'); ?>/api/send-listmsg <br>
...
'<?php echo config('app.base_node'); ?>/api/send-listmsg' \
--header 'Accept: */*' \
...
<?php /**PATH C:\xampp\htdocs\WHATSAPP-AUTO-SENDER\core\resources\views/api/sendlistbutton.blade.php ENDPATH**/ ?>