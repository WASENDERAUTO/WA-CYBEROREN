...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo asset('assets'); ?>/" data-template="vertical-menu-template">
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/css/rtl/core.css" class="template-customizer-core-css" />
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/libs/sweetalert2/sweetalert2.css" />
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
...
<body>
                        ...
                        <div class="app-brand justify-content-center mb-4 mt-2">
                            <a href="#" class="app-brand-link gap-2">
                                <span class="app-brand-logo demo" style="height: unset;">
                                    <img style="height: 30px" src="<?php echo asset('assets/img/logo.png'); ?>" alt="walix">
                                </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Welcome to WA-CYBEROREN! 👋</h4>
                        <p class="mb-4">Please sign-in to your account!</p>

                        <form class="mb-3" action="<?php echo route('login'); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
                                <label for="email" class="form-label">Username</label>
                                <input type="text" class="form-control" value="<?php echo e(config('app.isdemo') ? 'admin' : ''); ?>" name="username" placeholder="Enter your username" autofocus required />
                            </div>
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" class="form-control" value="<?php echo e(config('app.isdemo') ? 'admin' : ''); ?>" name="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
    ...
    <!-- Vendors JS -->
    <script src="<?php echo asset('assets'); ?>/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
    <script src="<?php echo asset('assets'); ?>/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
    <script src="<?php echo asset('assets'); ?>/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
...
<?php /**PATH C:\xampp\htdocs\WA-CYBEROREN\core\resources\views/auth/login.blade.php ENDPATH**/ ?>