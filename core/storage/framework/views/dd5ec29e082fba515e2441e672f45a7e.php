...
<div id="accordionPayment" class="accordion">
    <div class="card">
        <div class="card-body">
            ...
            <span class="text-info">Endpoint :</span> <?php echo config('app.base_node'); ?>/api/send-button <br>
...
'<?php echo config('app.base_node'); ?>/api/send-button' \
--header 'Accept: */*' \
...
<?php /**PATH C:\xampp\htdocs\WHATSAPP-AUTO-SENDER\core\resources\views/api/sendbutton.blade.php ENDPATH**/ ?>