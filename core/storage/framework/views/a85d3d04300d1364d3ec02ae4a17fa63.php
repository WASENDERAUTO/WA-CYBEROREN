...
<div id="accordionPayment" class="accordion">
    <div class="card">
        <div class="card-body">
            ...
            <span class="text-info">Endpoint :</span> <?php echo config('app.base_node'); ?>/api/send-media <br>
...
'<?php echo config('app.base_node'); ?>/api/send-media' \
--header 'Accept: */*' \
...
curl_setopt_array($curl, [
  CURLOPT_URL => "<?php echo config('app.base_node'); ?>/api/send-media",
...
<?php /**PATH C:\xampp\htdocs\WHATSAPP-AUTO-SENDER\core\resources\views/api/sendmedia.blade.php ENDPATH**/ ?>