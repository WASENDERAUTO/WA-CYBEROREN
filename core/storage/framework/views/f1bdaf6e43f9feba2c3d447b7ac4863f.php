<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item  <?php echo e(Route::is('dashboard') ? 'active' : ''); ?>">
            <a href="<?php echo route('dashboard'); ?>" class="menu-link">
        ...
        <li class="menu-item <?php echo e(Route::is('responder*') ? 'active' : ''); ?>">
            <a href="<?php echo route('responder'); ?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-message-2-code" style="margin-bottom: 2px;"></i>
                <div data-i18n="Auto Responders">Chatbot</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(Route::is('phonebook*') ? 'active' : ''); ?>">
            <a href="<?php echo route('phonebook'); ?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-address-book" style="margin-bottom: 2px;"></i>
                <div data-i18n="Phone Book">Phone Book</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(Route::is('campaigns.*') ? 'active' : ''); ?>">
            <a href="<?php echo route('campaigns.index'); ?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-mail" style="margin-bottom: 2px;"></i>
                <div data-i18n="Campaigns">Campaigns</div>
            </a>
        </li>
        
        <li class="menu-item <?php echo e(Route::is('single*') ? 'active' : ''); ?>">
            <a href="<?php echo route('single'); ?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-brand-telegram" style="margin-bottom: 2px;"></i>
                <div data-i18n="Single Sender">Single Sender</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(Route::is('apidocs*') ? 'active' : ''); ?>">
            <a href="<?php echo route('apidocs'); ?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-flame" style="margin-bottom: 2px;"></i>
                <div data-i18n="Rest Api">Rest Api</div>
            </a>
        </li>
        <li class="menu-item <?php echo e(Route::is('plugins*') ? 'active' : ''); ?>">
            <a href="<?php echo route('plugins'); ?>" class="menu-link">
        ...
        <li class="menu-item <?php echo e(Route::is('files') ? 'active' : ''); ?>">
            <a href="<?php echo route('files'); ?>" class="menu-link">
                <i class="menu-icon tf-icons ti ti-folder" style="margin-bottom: 2px;"></i>
                <div data-i18n="File Manager">File Manager</div>
            </a>
        </li>
        <?php if($auth->role == 'admin'): ?>
            <li class="menu-item <?php echo e(Route::is('admin*') ? 'active' : ''); ?>">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="<?php echo route('admin.users'); ?>" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?php echo route('logout'); ?>" class="menu-link">
...
<?php /**PATH C:\xampp\htdocs\WA-CYBEROREN\core\resources\views/dash/layouts/menu.blade.php ENDPATH**/ ?>