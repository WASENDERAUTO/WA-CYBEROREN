                            ...
                            <form id="form-campaign-store" method="POST" onSubmit="return false">
                                <div id="step1" class="content">
                                    <div class="alert alert-primary d-flex align-items-center" role="alert">
                                        ...
                                        <div class="d-block">
                                            Create Campaign for <span class="fw-bold"> <?php echo e($main_device->session_name); ?> <?php echo $main_device->whatsapp_number ? "<small>($main_device->whatsapp_number)</small>" : ''; ?> </span> device.
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <select name="phonebook_id" required class="form-select">
                                                    ...
                                                    <?php $__currentLoopData = $phonebook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($pb->id); ?>"><?php echo e($pb->title); ?> (<?php echo e($pb->contacts_count); ?> Contacts)</option>
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="datetime-local" name="scheduled_at" class="form-control" required value="<?php echo e(now()); ?>">
...
<?php $__env->startPush('js'); ?>
    ...
    <script src="<?php echo asset('assets/libvelixs/ilsya.message.js?v=12'); ?>"></script>
    <script>
        ...
        var dbs = ilsya.datatables({
            url: "<?php echo e(route('campaigns.ajax')); ?>",
            url_delete: "<?php echo e(route('campaigns.delete')); ?>",
        ...
        $(document).on('click', '.is-change-status', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('campaigns.ajax.changestatus')); ?>",
                type: "POST",
                headers: {
        ...
        $(".is-campaign-store").on('click', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('campaigns.store')); ?>",
                type: "POST",
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
...
<?php $__env->startPush('cssvendor'); ?>
    ...
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/libs/bs-stepper/bs-stepper.css" />
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/libs/bootstrap-select/bootstrap-select.css" />
    <link rel="stylesheet" href="<?php echo asset('assets'); ?>/vendor/libs/select2/select2.css" />
<?php $__env->stopPush(); ?>

<?php $__env->startPush('jsvendor'); ?>
    <script src="<?php echo asset('assets'); ?>/vendor/libs/bs-stepper/bs-stepper.js"></script>
    <script src="<?php echo asset('assets'); ?>/vendor/libs/bootstrap-select/bootstrap-select.js"></script>
    <script src="<?php echo asset('assets'); ?>/vendor/libs/select2/select2.js"></script>
    <script src="<?php echo asset('assets'); ?>/vendor/libs/datatables-bs5/datatables-bootstrap5.js"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('dash.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WHATSAPP-AUTO-SENDER\core\resources\views/campaigns/index.blade.php ENDPATH**/ ?>