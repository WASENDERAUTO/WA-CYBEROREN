    ...
    <div class="modal fade" id="modal-add" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="user-store" action="<?php echo e(route('admin.users.store')); ?>" method="post" style="display: contents" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="user-update" action="<?php echo e(route('admin.users.update')); ?>" method="post" style="display: contents" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startPush('js'); ?>
    <script>
        ...
        var dbs = ilsya.datatables({
            url: "<?php echo e(route('admin.users.ajax')); ?>",
            header: `Manage Users`,
            columns: [{
                    data: 'responsive_id'
                },
        ...
        $(document).on('click', ".is-btn-user-edit", function() {
            ...
            ilsya.ajax({
                type: "GET",
                url: "<?php echo e(route('admin.users.edit', '')); ?>" + "/" + id,
        ...
        $(document).on('click', ".is-btn-user-delete", function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ilsya.ajax({
                        url: "<?php echo e(route('admin.users.delete', '')); ?>" + "/" + id,
                        addons_success: function() {
                            dbs.ajax.reload()
                        }
                    })
...
<?php echo $__env->make('dash.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\WHATSAPP-AUTO-SENDER\core\resources\views/admin/users.blade.php ENDPATH**/ ?>