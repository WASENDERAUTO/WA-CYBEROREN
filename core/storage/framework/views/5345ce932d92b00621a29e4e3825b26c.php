...
<div id="accordionPayment" class="accordion">
    <div class="card">
        <div class="card-body">
            ...
            <span class="text-info">Endpoint :</span> <?php echo config('app.base_node'); ?>/api/send-message <br>
  ...
  "api_key" => "<?php echo $main_device->api_key; ?>",
...
'<?php echo config('app.base_node'); ?>/api/send-message' \
--header 'Accept: */*' \
...
curl_setopt_array($curl, [
  CURLOPT_URL => "<?php echo config('app.base_node'); ?>/api/send-message",
...
<?php /**PATH C:\xampp\htdocs\WHATSAPP-AUTO-SENDER\core\resources\views/api/sendtext.blade.php ENDPATH**/ ?>